// DML plumbing tests covering BulkInsert collapse into one multi-page segment, EXPLAIN smoke, segment identity sidecar stamping, and table-path routing for new vs migrated tables.
package engine
