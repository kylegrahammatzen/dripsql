...
// ValidityWords returns the number of bitmap words needed for n rows and returns zero for non-positive n.
...
// FillValid marks n rows valid and expects valid to have exactly ValidityWords(n) words.
